...
var sounds = [preload("res://Crossover/Squirrel Time/Objects/Enemy/Fox1.wav"),preload("res://Crossover/Squirrel Time/Objects/Enemy/Fox2.wav"),preload("res://Crossover/Squirrel Time/Objects/Enemy/Fox3.wav")]
var eat_sounds = [preload("res://Crossover/Squirrel Time/Objects/Enemy/FoxEat1.wav"),preload("res://Crossover/Squirrel Time/Objects/Enemy/FoxEat2.wav"),preload("res://Crossover/Squirrel Time/Objects/Enemy/FoxEat3.wav"),preload("res://Crossover/Squirrel Time/Objects/Enemy/FoxEat4.wav")]
var meme_sounds = [preload("res://Crossover/Squirrel Time/Objects/Enemy/Ding.wav")]
