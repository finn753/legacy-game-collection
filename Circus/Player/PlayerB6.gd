...
func _physics_process(delta):
	...
	velocity.x = speed * movement_dir * delta
	...
	velocity = move_and_slide_with_snap(velocity.rotated(-grav_rot),gravity_normal*snap,-gravity_normal,true).rotated(grav_rot)
